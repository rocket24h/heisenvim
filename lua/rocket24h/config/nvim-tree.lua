...
require("nvim-tree").setup({
	...
	renderer = {
		...
		icons = {
			...
			glyphs = {
				-- Don't feel like changing these
				default = "",
				symlink = "",
				bookmark = "󰆤",
				modified = "●",
				...
				git = {
					unstaged = utils.git.unstaged,
					staged = utils.git.staged,
					unmerged = utils.git.unmerged,
					renamed = utils.git.renamed,
					untracked = utils.git.untracked,
					deleted = utils.git.deleted,
					ignored = utils.git.ignored,
				},
			},
		},
	},
